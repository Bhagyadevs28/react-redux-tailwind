...
const Header = (insideHome) => {
  ...
  <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
    ...
    <ul className='flex-1 text-right'>
      ...
      <li className='list-none inline-block px-5'><Link to={'/wishlist'}><i className='fa-solid fa-heart text-red-600'></i>Wishist <span className='bg-black text-white rounded p-1'>0</span></Link></li>
